  ...
  return !loading ? (
    <>
      ...
      <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
        <BlurCircle top='350px' right='400px'/>
          {dashboardData.activeShows.map((show) => (
            <div key={show._id} className='w-67 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transition duration-300'>
