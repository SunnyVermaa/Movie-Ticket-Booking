...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      <div className='flex items-center gap-4  text-[#ce9edded]'>
      ...
      <p className='max-w-md text-[#e0eef8df]'>This is movies and i am writing their discription but i dont have any discription so that i only write any things but you have to not worried about because this is only frontend</p>
